...
if (typeof(blastGasQuantity) == 'undefined') {
  setCO2ToZero();
  missingRequiredInputNote('CO2','blastGasQuantity');
}
...
if (typeof(cokeGasQuantity) == 'undefined') {
  setCO2ToZero();
  missingRequiredInputNote('CO2','cokeGasQuantity');
}

if (typeof(byprodQuantity) == 'undefined') {
  setCO2ToZero();
  missingRequiredInputNote('CO2','byprodQuantity');
}

if (typeof(byprodCarbon) == 'undefined') {
  setCO2ToZero();
  missingRequiredInputNote('CO2','byprodCarbon');
}
...
if (co2Calculable == true) {
  co2Emissions = ((materialQuantity * carbonContent) + (blastGasQuantity * blastGasCarbon) - (cokeQuantity * cokeCarbon) - (cokeGasQuantity * cokeGasCarbon) - (byprodQuantity * byprodCarbon)) * parseFloat(stoich);
}
...
if (typeof(cokeQuantity) == 'undefined') {
  ...
  missingRequiredInputNote('CH4','cokeQuantity');
} else {
  ch4Emissions = cokeQuantity * (ch4EM/1000000);
