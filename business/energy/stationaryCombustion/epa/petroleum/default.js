...
if (volume == null && energyConsumed == null) {
  ...
  quantity = volume * energyPerVolume;
...
massCH4PerEnergy = parseFloat(dataFinder.getDataItemValue('business/energy/stationaryCombustion/epa/ch4andn2ofactors', 'type=petroleum,context='+burningContext, 'massCH4PerEnergy'));
massCH4PerEnergy /= 1000.0; // convert g to kg
 
// get N2O emissions factor
massN2OPerEnergy = parseFloat(dataFinder.getDataItemValue('business/energy/stationaryCombustion/epa/ch4andn2ofactors', 'type=petroleum,context='+burningContext, 'massN2OPerEnergy'));
