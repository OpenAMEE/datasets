...
if (fractionVolatilised == null) { // direct only calculation
  n2oEmissions = livestockNumber * massNExcretedPerHeadPerTime * massN2OPerMassNDirect * stoich;
} else { // direct plus indirect emissions calculation
  n2oEmissions = livestockNumber * massNExcretedPerHeadPerTime * (massN2OPerMassNDirect + (fractionVolatilised * massN2OPerMassNVolatilised)) * stoich;
}
