...
fac = kgCO2PerTonneKm + kgCO2ePerTonneKmForCH4 + kgCO2ePerTonneKmForN2O;
...
if (kgCO2PerTonneKm != 0) {
  ...
  co2=dataFinder.getDataItemValue('transport/plane/generic/freight/defra', 'type='+atype,'kgCO2PerTonneKm')
  ch4=dataFinder.getDataItemValue('transport/plane/generic/freight/defra', 'type='+atype,'kgCO2ePerTonneKmForCH4')
  n2o=dataFinder.getDataItemValue('transport/plane/generic/freight/defra', 'type='+atype,'kgCO2ePerTonneKmForN2O')
  co2e=(parseFloat(co2)+parseFloat(ch4)+parseFloat(n2o));
  dist * mass * RFI * co2e;
