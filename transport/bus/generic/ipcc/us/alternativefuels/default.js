...
if(distance == "" && distancePerJourney == ""){
     ...
     if (distancePerJourney == ""){
          if(fuelEfficiency == ""){ //CO2 fuel-based calcualtion
               ((distance * (N2ODistanceFactor + CH4DistanceFactor)) + (CO2VolumeFactor * fuelConsumed)) * accountedProportion;
          } else { //CO2 distance-based calculation
               CO2DistanceFactor = CO2VolumeFactor / fuelEfficiency;
               (distance * (N2ODistanceFactor + CH4DistanceFactor + CO2DistanceFactor)) * accountedProportion;
          }
     } else {
          ...
          if(fuelEfficiency == ""){ //CO2 fuel-based calcualtion
               ((distancePerJourney * journeys * (N2ODistanceFactor + CH4DistanceFactor)) + (CO2VolumeFactor * fuelConsumed)) * accountedProportion;
          } else { //CO2 distance-based calculation
               CO2DistanceFactor = CO2VolumeFactor / fuelEfficiency;
               (distancePerJourney * journeys * (N2ODistanceFactor + CH4DistanceFactor + CO2DistanceFactor)) * accountedProportion;
          }
     }
}
