...
decayProportion = Math.pow(Math.E, (-decayRate * timeSinceClosed)) - Math.pow(Math.E, (-decayRate * timeSinceOpened))
gasProduced = wasteDepositionRate * ultimateMethanePotential * decayProportion

ch4Emissions = gasProduced * standardDensity * ((1 - collectionEfficiency) * (1 - fractionUncollectedOxidising) + collectionEfficiency * (1 - fractionCollectedBurned));
